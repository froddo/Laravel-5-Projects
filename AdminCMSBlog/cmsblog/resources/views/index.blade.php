                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="post__comments">
                                            ...
                                            <a href="{{ route('post.single', [$first_post->slug]) }}">Comments</a>
                                        </span>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="post__comments">
                                            <a href="!#"><i class="fa fa-comment-o" aria-hidden="true"></i></a>
                                            <a href="{{ route('post.single', [$second_post->slug]) }}">Comments</a>
                                        </span>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="post__comments">
                                            <a href="#!"><i class="fa fa-comment-o" aria-hidden="true"></i></a>
                                             <a href="{{ route('post.single', [$third_post->slug]) }}">Comments</a>
                                        </span>
            ...
            <div class="container">
                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $tutorial->featured }}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{ route('post.single', [$tutorial->slug]) }}">{{ $tutorial->title }}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($laravel->posts()->orderBy('created_at', 'desc')->take(3)->get() as $lara)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $lara->featured }}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{ route('post.single', [$lara->slug]) }}">{{ $lara->title }}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">PHP-OOP</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($php->posts()->orderBy('created_at', 'desc')->take(3)->get() as $p)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{asset($p->featured)}}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title"><a href="{{ route('post.single', [$p->slug]) }}">{{ $p->title }}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="form_search-wrap">
                <form method="post" action="{{ route('results.gets') }}">
                    {{csrf_field()}}
